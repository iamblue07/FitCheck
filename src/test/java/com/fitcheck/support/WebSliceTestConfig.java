...
import com.fitcheck.common.security.properties.CorsProperties;
...
public class WebSliceTestConfig {
    ...
    public static final String TEST_ISSUER = "https://fitcheck.local";
    public static final String TEST_AUDIENCE = "fitcheck-api";
